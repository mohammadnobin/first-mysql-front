                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-4">
                            ...
                            <button className="px-3 sm:px-4 py-2 text-sm font-medium text-white bg-linear-to-r from-purple-600 to-blue-600 rounded-lg hover:shadow-lg transition-all">
                                Export
                            </button>
                        </div>
                    </div>
